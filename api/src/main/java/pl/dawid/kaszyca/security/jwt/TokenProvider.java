package pl.dawid.kaszyca.security.jwt;
...
import pl.dawid.kaszyca.config.JsonWebTokenProperties;
...
public class TokenProvider {
    ...
    public TokenProvider(JsonWebTokenProperties jsonWebTokenProperties) {
